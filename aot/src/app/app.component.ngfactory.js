...
var View_AppComponent_Host0 = (function (_super) {
    ...
    View_AppComponent_Host0.prototype.createInternal = function (rootSelector) {
        this._el_0 = import3.selectOrCreateRenderHostElement(this.renderer, 'rio-app', import3.EMPTY_INLINE_ARRAY, rootSelector, null);
...
export var AppComponentNgFactory = new import7.ComponentFactory('rio-app', View_AppComponent_Host0, import0.AppComponent);
...
export var View_AppComponent0 = (function (_super) {
    ...
    View_AppComponent0.prototype.detectChangesInternal = function (throwOnChange) {
        var currVal_2 = import3.inlineInterpolate(1, '', this.context.myTitle, '');
