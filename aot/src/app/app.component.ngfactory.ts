...
class View_AppComponent_Host0 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    this._el_0 = import3.selectOrCreateRenderHostElement(this.renderer,'rio-app',import3.EMPTY_INLINE_ARRAY,rootSelector,(null as any));
...
export const AppComponentNgFactory:import7.ComponentFactory<import0.AppComponent> = new import7.ComponentFactory<import0.AppComponent>('rio-app',View_AppComponent_Host0,import0.AppComponent);
...
export class View_AppComponent0 extends import1.AppView<import0.AppComponent> {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    const currVal_2:any = import3.inlineInterpolate(1,'',this.context.myTitle,'');
